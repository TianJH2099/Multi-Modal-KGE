...
class resnet50(nn.Module):
    ...
    def __init__(self, class_num=751, droprate=0.5, stride=2, circle=False, ibn=False, linear_num=512):
        ...
        if ibn==True:
            model_ft.load_state_dict(torch.load(R'../input/pretrained-model/resnet50-0676ba61.pth'))
        ...
        self.model = model_ft
        self.circle = circle
        self.classifier = ClassBlock(2048, class_num, droprate, bnorm=False,linear=linear_num, return_f = circle)
